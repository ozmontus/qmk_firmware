...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_GRV,		KC_LGUI,      KC_LALT,  KC_LEFT,KC_RGHT,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_AMPR, KC_1,   KC_2,    KC_3,    KC_BSLS, CTL_T(KC_SLSH),
                         KC_TRNS,KC_0,  ALT_T(KC_DOT),    KC_EQL,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
 ...
 * |        |      |  B   |  A   |  S   |  D   |------|           |------|      |      |      |      |      |  Play  |
 * |--------+------+------+------+------+------|  V   |           |      |------+------+------+------+------+--------|
 * |        |  Z   | Lsft |  X   |  G   |  F   |      |           |      |      |      | Prev | Next |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      | BLANK|  C   | Lclk | Rclk |                                       |VolUp |VolDn | Mute |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |  4   |  3   |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
// GAME
[GAME] = KEYMAP(
       KC_TRNS, KC_TRNS, KC_TRNS, KC_6,    KC_7,   KC_8,    KC_9,
       KC_TRNS, KC_TRNS, KC_5,    KC_Q,    KC_W,   KC_E,    KC_T,
       KC_TRNS, KC_TRNS, KC_B,    KC_A,    KC_S,   KC_D,
       KC_TRNS, KC_Z,    KC_LSFT, KC_X,    KC_G,   KC_F,    KC_V,
       KC_TRNS, KC_NO,   KC_C,    KC_BTN1, KC_BTN2,
                                           KC_4,    KC_3,
                                                    KC_2,
                                  KC_R,    KC_SPC,  KC_1,
    // right hand
